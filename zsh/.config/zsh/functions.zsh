...
# Backup a file or directory with timestamp
...
# Enhanced activate function with auto-detection
# Usage: activate [path]
activate() {
    ...
    echo "No virtual environment found. Checked: .venv, venv, env, .env"
    return 1
}

# Usage: note "oh something important"
note() {
